...
import com.krishnakant.SecurityApp.SecurityApplication.entities.Session;
import com.krishnakant.SecurityApp.SecurityApplication.entities.User;
import com.krishnakant.SecurityApp.SecurityApplication.repositories.SessionRepository;
...
public class SessionService {
    ...
    public void generateNewSession(User user, String refreshToken) {
        ...
        if(userSessions.size() == SESSION_LIMIT){
            ...
            Session leastRecentlyUserSession = userSessions.getFirst();
